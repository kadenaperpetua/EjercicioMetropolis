...
public class Metropolis {
    public static void main(String[] args) {
        ...
        if (esMetropolis(esCapital, numeroDeCiudadanos, impuestosPorCiudadano)){
    ...
    private static boolean esMetropolis(boolean esCapital, int numeroDeCiudadanos, double impuestosPorCiudadano){
